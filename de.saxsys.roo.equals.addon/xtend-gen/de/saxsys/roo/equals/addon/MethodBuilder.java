    ...
    MethodMetadata _xblockexpression = null;
    {
      ...
      if (((Boolean)_operator_notEquals)) {
        ...
        MethodMetadata _xblockexpression_1 = null;
        {
          ...
          List<AnnotationMetadata> _annotations_1 = sig.getAnnotations();
          final Function1<AnnotationMetadata,AnnotationMetadataBuilder> function_3 = new Function1<AnnotationMetadata,AnnotationMetadataBuilder>() {
              public AnnotationMetadataBuilder apply(AnnotationMetadata a) {
                AnnotationMetadataBuilder _annotationMetadataBuilder = new AnnotationMetadataBuilder(a);
                return _annotationMetadataBuilder;
              }
            };
          List<AnnotationMetadataBuilder> _map_3 = ListExtensions.map(_annotations_1, function_3);
          typeConverted_mmdbuilder.setAnnotations(_map_3);
